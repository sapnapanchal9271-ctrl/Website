...
// Enhanced scroll event listener with navbar effects
...
// Enhanced smooth hover effects for cards
const cards = document.querySelectorAll('.timeline-content, .skill-item, .stat-item, .contact-item');
cards.forEach(card => {
...
toolItems.forEach((tool, index) => {
    ...
    tool.addEventListener('mouseenter', function() {
        ...
        setTimeout(() => {
            if (name) name.style.transform = 'translateY(-2px)';
        }, 100);
